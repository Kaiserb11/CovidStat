...
class Chi extends StatefulWidget {
  @override
  _ChiState createState() => _ChiState();
}
        ...
        builder: (context, snapshot)  {
          ...
          return Column(
            ...
            children: <Widget>[
              ...
              Text(
                snapshot.data.documents[1]['confirm'].toString(),
                style: TextStyle(
                  color: Theme.of(context).primaryColor,
                  fontSize: 80,
                  fontFamily: 'Bebas',
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[1]['active'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[1]['recovered'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[1]['death'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,
...
class StatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    onTap: () {                          
        Navigator.push(
    context,
    link == 'pak' ? MaterialPageRoute(builder: (context) => Pak()): link == 'ban' ? MaterialPageRoute(builder: (context) => Ban()): link == 'ind' ? MaterialPageRoute(builder: (context) => Dashboard()): link == 'nep' ? MaterialPageRoute(builder: (context) => Nep()): "lol",
  );
        }, 
      );
    }

...
class Pak extends StatefulWidget {
  @override
  _PakState createState() => _PakState();
}
        ...
        builder: (context, snapshot)  {
          ...
          return Column(
            ...
            children: <Widget>[
              ...
              Text(
                snapshot.data.documents[4]['confirm'].toString(),
                style: TextStyle(
                  color: Theme.of(context).primaryColor,
                  fontSize: 80,
                  fontFamily: 'Bebas',
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[4]['active'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[4]['recovered'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[4]['death'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,
...
class StatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    onTap: () {                          
        Navigator.push(
    context,
    link == 'ind' ? MaterialPageRoute(builder: (context) => Dashboard()): link == 'ban' ? MaterialPageRoute(builder: (context) => Ban()): link == 'chi' ? MaterialPageRoute(builder: (context) => Chi()): link == 'nep' ? MaterialPageRoute(builder: (context) => Nep()): "lol",
  );
        }, 
      );
    }

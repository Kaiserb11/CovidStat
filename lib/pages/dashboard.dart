        ...
        builder: (context, snapshot)  {
          ...
          return Column(
            ...
            children: <Widget>[
              ...
              Text(
                snapshot.data.documents[2]['confirm'].toString(),
                style: TextStyle(
                  color: Theme.of(context).primaryColor,
                  fontSize: 80,
                  fontFamily: 'Bebas',
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[2]['active'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[2]['recovered'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[2]['death'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,

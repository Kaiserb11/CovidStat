...
class Nep extends StatefulWidget {
  @override
  _NepState createState() => _NepState();
}
        ...
        builder: (context, snapshot)  {
          ...
          return Column(
            ...
            children: <Widget>[
              ...
              Text(
                snapshot.data.documents[3]['confirm'].toString(),
                style: TextStyle(
                  color: Theme.of(context).primaryColor,
                  fontSize: 80,
                  fontFamily: 'Bebas',
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[3]['active'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[3]['recovered'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            snapshot.data.documents[3]['death'].toString(),                     
                            style: TextStyle(
                              fontSize: 20,
                              color: Theme.of(context).accentColor,
                              fontWeight: FontWeight.bold,
...
class StatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    onTap: () {                          
        Navigator.push(
    context,
    link == 'pak' ? MaterialPageRoute(builder: (context) => Pak()): link == 'ban' ? MaterialPageRoute(builder: (context) => Ban()): link == 'chi' ? MaterialPageRoute(builder: (context) => Chi()): link == 'ind' ? MaterialPageRoute(builder: (context) => Dashboard()): "lol",
  );
        }, 
      );
    }
